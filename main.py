...
def perform_addition():
    try:
        ...
        if rounding_mode == "RTNTE":
            ...
            text_output.insert(tk.END, "Rounded Binary Numbers:\n")
            text_output.insert(tk.END, f"Binary 1: [{round_binary1[:-3]} {round_binary1[-3:]}] x 2^{exponent1}\n")
            text_output.insert(tk.END, f"Binary 2: [{round_binary2[:-3]} {round_binary2[-3:]}] x 2^{exponent2}\n")
...
test(1, "-1.0", "3", "1.0", "3", "GRS", "3", "-1.0", "3", "1.0", "3", "-1.0", "3", "1.0", "3", "-1.00 000", "3", "1.00 000", "3", "0.00000", "3", "0.00", "0")
test(2, "1.0", "3", "-1.0", "3", "GRS", "3", "1.0", "3", "-1.0", "3", "1.0", "3", "-1.0", "3", "1.00 000", "3", "-1.00 000", "3", "0.00000", "3", "0.00", "0")
test(3, "-1.0", "3", "-1.0", "3", "GRS", "3", "-1.0", "3", "-1.0", "3", "-1.0", "3", "-1.0", "3", "-1.00 000", "3", "-1.00 000", "3", "-10.00000", "3", "-1.00", "4")
test(4, "1.0", "3", "1.0", "3", "GRS", "3", "1.0", "3", "1.0", "3", "1.0", "3", "1.0", "3", "1.00 000", "3", "1.00 000", "3", "10.00000", "3", "1.00", "4")
...
test(6, "1.0111110010011", "5", "1.00111111100011", "3", "GRS", "9", "1.0111110010011", "5", "1.00111111100011", "3", "1.0111110010011", "5", "0.0100111111100011", "5", "1.01111100 101", "5", "0.01001111 111", "5", "1.11001100100", "5", "1.11001100", "5")
...
test(8, "100.1110111001001", "5",     "0.0110111110101", "7",     "GRS", "8",      "1.001110111001001", "7",      "1.10111110101", "5",      "1.001110111001001", "7",      "0.0110111110101", "7",      "1.0011101 111", "7",      "0.0110111 111", "7",      "1.1010101110", "7",      "1.1010110", "7")
...
test(10, "100.1110111001001", "5",     "0.0110111110101", "7",     "GRS", "8",      "1.001110111001001", "7",      "1.10111110101", "5",      "1.001110111001001", "7",      "0.0110111110101", "7",      "1.0011101 111", "7",      "0.0110111 111", "7",      "1.1010101110", "7",      "1.1010110", "7")
...
test(13, "100.1110111001001", "5",     "-0.01101111101010001", "7",     "GRS", "10",      "1.001110111001001", "7",      "-1.101111101010001", "5",      "1.001110111001001", "7",      "-0.01101111101010001", "7",      "1.001110111 001", "7",      "-0.011011111 011", "7",    "0.110010111110", "7",     "1.100110000", "6")
test(14, "1.0010", "3",     "-1.0001", "3",     "GRS", "3",      "1.0010", "3",      "-1.0001", "3",      "1.0010", "3",      "-1.0001", "3",      "1.00 100", "3",      "-1.00 010", "3",    "0.00010", "3",     "1.00", "-1")
test(15, "100.1110111001001", "5",     "0.01101111101010001", "7",     "GRS", "7",      "1.001110111001001", "7",      "1.101111101010001", "5",      "1.001110111001001", "7",      "0.01101111101010001", "7",      "1.001110 111", "7",      "0.011011 111", "7",    "1.101010110", "7",     "1.101011", "7")
test(16, "1.1111110010", "6", "1.1111100011", "4", "GRS", "5", "1.1111110010", "6", "1.1111100011", "4", "1.1111110010", "6", "0.011111100011", "6", "1.1111 111", "6", "0.0111 111", "6", "10.0111110", "6", "1.0100", "7")
test(17, "-1.1010", "-2", "-0.101", '-4', "RTNTE", "3", "-1.1010", "-2", "-1.01", "-5", "-1.1010", "-2", "-0.00101", "-2", "-1.10", "-2", "-0.01", "-2", "-1.11", "-2", "-1.11", "-2")
test(18, "-1.1010", "-2", "-0.101", '-4', "GRS", "3", "-1.1010", "-2", "-1.01", "-5", "-1.1010", "-2", "-0.00101", "-2", "-1.10 100", "-2", "-0.00 101", "-2", "-1.11001", "-2", "-1.11", "-2")
test(19, "-100.1110111001001", "5",     "0.01101111101010001", "7",     "GRS", "10",      "-1.001110111001001", "7",      "1.101111101010001", "5",      "-1.001110111001001", "7",      "0.01101111101010001", "7",      "-1.001110111 001", "7",      "0.011011111 011", "7",    "-0.110010111110", "7",     "-1.100110000", "6")
...
test(26, "001.1", "5", "0.000000001", "5", "GRS", "3", "1.1", "5", "1.0", '-4', "1.1", "5", "0.0000000010", "5", "1.10 000", "5", "0.00 001", "5", "1.10001", "5", "1.10", "5")
test(27, "1100.10", "-4", "0.110010", "5", "GRS", "4", "1.10010", "-1", "1.10010", '4', "0.0000110010", "4", "1.10010", '4', "0.000 011", "4", "1.100 100", '4', "1.100111", "4", "1.101", "4")
test(28, "-1.0101", "3", "0.001", "5", "RTNTE", "4", "-1.0101", "3", "1.0", "2", "-1.0101", "3", "0.10", "3", "-1.010", "3", "0.100", "3", "-0.110", "3", "-1.100", "2")
test(29, "0.0010", "3", "10010", "-1", "GRS", "3", "1.0", "0", "1.00100", "3", "0.0010", "3", "1.00100", "3", "0.00 100", "3", "1.00 100", "3", "1.01000", "3", "1.01", "3")
test(30, "-1000.0000", "-3", "-0.00000000000001", "13", "RTNTE", "6", "-1.0000000", "0", "-1.0", "-1", "-1.0000000", "0", "-0.10", "0", "-1.00000", "0", "-0.10000", "0", "-1.10000", "0", "-1.10000", "0")
test(31, "0000.0000", "-1", "0.00000000000000", "-2", "RTNTE", "2", "0.0000000", "2", "0.00000000000000", "-2", "0.0000000", "2", "0.000000000000000000", "2", "0.0", "2", "0.0", "2", "0.0", "2", "0.0", "0")
